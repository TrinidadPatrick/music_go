    ...
    <div className='w-full h-full flex flex-col'>
      ...
      >
        ...
        <div className="relative z-10 w-full min-h-[200px] flex flex-col justify-center items-center sm:items-start p-4 md:p-6 lg:p-8">
          ...
          <div className="absolute top-8 right-8 flex gap-4 opacity-60">
          ...
          <div className="max-w-4xl">
            ...
            <h1 className={`text-lg sm:text-xl md:text-3xl lg:text-4xl text-center sm:text-left text-white font-black mb-4 leading-10 transform transition-all duration-1000 ${animateText ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                                <span className="block bg-gradient-to-r from-white via-green-100 to-green-200 bg-clip-text text-transparent">
                MUSIC CHANGES THE
              </span>
              <span className="block bg-gradient-to-r from-green-300 via-green-200 to-white bg-clip-text text-transparent mt-1">
                WORLD BECAUSE IT
              </span>
              <span className="block bg-gradient-to-r from-green-400 via-green-300 to-green-200 bg-clip-text text-transparent mt-1">
                CHANGES PEOPLE
              </span>
            </h1>
            ...
            {/* Enhanced CTA button */}
            <div className={`transform transition-all duration-1000 delay-500 ${animateText ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
              <button 
              ...
              >
                <div className="flex items-center gap-3">
                  <Play className={`w-6 h-6 transition-transform duration-300 ${isHovered ? 'scale-110' : ''}`} fill="currentColor" />
                  <span className="font-black tracking-wide">LISTEN NOW</span>
                </div>
        ...
        {/* <div className="absolute bottom-8 left-8 flex items-end gap-1 opacity-60">
          {[...Array(8)].map((_, i) => (
            <div
              key={i}
