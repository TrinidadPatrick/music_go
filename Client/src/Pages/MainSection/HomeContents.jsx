      ...
      <ul className="text-sm text-white p-2 space-y-2">
        {selectedDropdown?.videoId && (
          <li
            onClick={(e) => {
              e.stopPropagation()
              handleSaveToLibrary(selectedDropdown)
            }}
        ...
        <li
          onClick={(e) => {
            e.stopPropagation()
            selectPlaylist(selectedDropdown)
          }}
          className="hover:bg-gray-700 p-2 rounded"
        >
          Add to Playlist
                    ...
                    >
                      {isAuthenticated && (
                        <button
                          ...
                          className="md:hidden md:group-hover:block hover:bg-gray-500 hover:rounded-full p-1 cursor-pointer absolute right-5 z-50"
                        >
                          <MoreHorizontal size={20} className="text-white z-10 relative" />
                          {showDropdown(track) && <DropDown />}
                        </button>
                      )}
                      ...
                      <div
                        className="w-full flex items-center justify-center aspect-square bg-cover bg-center opacity-75 bg-no-repeat rounded-lg"
                        style={{
