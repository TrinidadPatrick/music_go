  ...
  return (
    <div className='w-full h-full overflow-y-auto min-w-0 min-h-0'>
      <div className='grid grid-cols-1'>
        {/* Hero Section */}
        <section className="m-5 relative overflow-hidden rounded-2xl mb-8">
          {/* Gradient background */}
          ...
          {/* Content */}
          <div className="relative z-10 px-6 md:px-10 py-12 md:py-10">
            {/* Badge */}
            <span className="inline-block px-4 py-1.5 rounded-full text-xs font-semibold tracking-wider uppercase bg-primary text-primary-foreground mb-6">
              Discover the Power
            </span>
            {/* Headline */}
            ...
            <Button
              ...
              size="lg"
              className="bg-gradient-to-r from-primary to-accent text-primary-foreground font-semibold px-6 py-3 rounded-full hover:opacity-90 transition-opacity shadow-glow"
            >
